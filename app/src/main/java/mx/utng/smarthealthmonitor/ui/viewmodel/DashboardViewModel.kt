...
import androidx.lifecycle.ViewModel import kotlinx.coroutines.flow.*
...
// Si es 0 (sin dato aún), usar valor simulado.
    val fc: StateFlow<Int> = SmartHealthRepository.fcFlow
        ...
        .stateIn(
            ...
            started	= SharingStarted.WhileSubscribed(5_000), initialValue	= MockData.fcActual
        )
    ...
    val pasos: StateFlow<Int> = SmartHealthRepository.pasosFlow
        ...
        .stateIn(
            scope	= viewModelScope,
            started	= SharingStarted.WhileSubscribed(5_000), initialValue = MockData.pasosActual
        )
